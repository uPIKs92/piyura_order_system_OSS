...
const tabsListVariants = cva(
  "group/tabs-list items-center justify-center p-1 text-muted-foreground group-data-vertical/tabs:h-fit group-data-vertical/tabs:flex-col group-data-vertical/tabs:rounded-2xl data-[variant=line]:rounded-none",
  {
    variants: {
      variant: {
        default:
  ...
  return (
    <TabsPrimitive.Tab
      ...
      className={cn(
        ...
        "group-data-[variant=segment]/tabs-list:h-10 group-data-[variant=segment]/tabs-list:rounded-xl group-data-[variant=segment]/tabs-list:data-active:shadow-sm group-data-[variant=segment]/tabs-list:after:hidden",
